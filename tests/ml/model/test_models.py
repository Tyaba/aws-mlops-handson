...
from ml.model import SGDClassifierCTRModel
from ml.model.models import MODELS
from ml.preprocessor import CTRModelPreprocessor

# from ml.model import SGDClassifierCTROptunaModel

params = {
    "sgd_classifier_ctr_model": (
        "sgd_classifier_ctr_model",
        SGDClassifierCTRModel,
        CTRModelPreprocessor,
    ),
    # "sgd_classifier_ctr_optuna_model": (
    #     "sgd_classifier_ctr_optuna_model",
    #     SGDClassifierCTROptunaModel,
    #     CTRModelPreprocessor,
    # ),
}
...
@pytest.mark.parametrize(
    "model_name, expected_model_class, expected_preprocessor_class",
    list(params.values()),
